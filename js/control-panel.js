    ...
    const sections = [
      {
        ...
        controls: [
          ...
          { key:'minWid',        label:'Min Width',  min:0.003, max:0.2,  step:0.001,dp:3, onchange: ()=>{ CTRL.rebuildSizes(); } },
          { key:'maxWid',        label:'Max Width',  min:0.005, max:0.5,  step:0.001,dp:3, onchange: ()=>{ CTRL.rebuildSizes(); } },
